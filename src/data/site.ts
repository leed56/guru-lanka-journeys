...
export const DESTINATIONS: Destination[] = [
  ...
  { id: "unawatuna", name: "Unawatuna", region: "South", x: 113, y: 676, interests: ["beach", "wellness"], blurb: "A curved bay minutes from the fort — swimming, diving and long lazy evenings." },
  ...
  { id: "bentota-area", name: "Bentota", region: "West", x: 71, y: 604, interests: ["beach", "wellness"], blurb: "River on one side, ocean on the other — watersports, Ayurveda and a lot of resort choice." },
  { id: "colombo", name: "Colombo", region: "West", x: 48, y: 520, interests: ["culture"], blurb: "The arrival city: markets, seafood, colonial arcades and a new skyline arguing with all of it." },
  { id: "negombo", name: "Negombo", region: "West", x: 44, y: 472, interests: ["beach", "wellness"], blurb: "Fifteen minutes from the airport, with fish markets, canals and a long open beach." },
  { id: "kalpitiya", name: "Kalpitiya", region: "West", x: 32, y: 300, interests: ["beach", "wildlife"], blurb: "Kitesurfing lagoons, dolphin pods and sandbar islands with nothing built on them." },
  { id: "kandy", name: "Kandy", region: "Hill Country", x: 177, y: 458, interests: ["culture", "spiritual", "mountains"], blurb: "The last royal capital, built around a lake and the temple that holds the Tooth Relic." },
  { id: "nuwara-eliya", name: "Nuwara Eliya", region: "Hill Country", x: 203, y: 516, interests: ["mountains", "wellness"], blurb: "Cool enough for a fire in the evening. Tea estates, a racecourse and hedged English gardens at 1,900m." },
  ...
  { id: "anuradhapura", name: "Anuradhapura", region: "Cultural Triangle", x: 139, y: 287, interests: ["spiritual", "culture"], blurb: "The first great capital: giant brick stupas, ancient reservoirs and the oldest recorded tree on earth." },
  ...
  { id: "sigiriya", name: "Sigiriya", region: "Cultural Triangle", x: 198, y: 346, interests: ["culture", "mountains"], blurb: "A palace on top of a 200m rock, with frescoes and water gardens still working below it." },
  { id: "dambulla", name: "Dambulla", region: "Cultural Triangle", x: 180, y: 363, interests: ["spiritual", "culture"], blurb: "Five cave temples under one overhang, painted end to end and full of Buddha images." },
];
