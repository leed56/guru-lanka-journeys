...
export const DESTINATIONS: Destination[] = [
  { id: "jaffna", name: "Jaffna", region: "North", x: 92, y: 70, interests: ["culture", "spiritual"], blurb: "The northern capital: palmyrah, libraries, its own kitchen and its own accent. Slow, proud and unlike anywhere else on the island." },
  { id: "nallur", name: "Nallur", region: "North", x: 104, y: 82, interests: ["spiritual", "culture"], blurb: "The great Hindu temple of the north, gold-lit at dusk and overwhelming during its August festival." },
  { id: "nagadeepa", name: "Nagadeepa", region: "North", x: 55, y: 78, interests: ["spiritual"], blurb: "An island pilgrimage site reached by ferry, sacred to Buddhists and Hindus alike." },
  { id: "delft", name: "Delft", region: "North", x: 43, y: 96, interests: ["culture"], blurb: "Coral-walled lanes, wild ponies and Dutch ruins on a flat windswept island." },
  { id: "trincomalee", name: "Trincomalee", region: "East", x: 271, y: 243, interests: ["beach", "spiritual"], blurb: "One of the world's great natural harbours, with a cliff-top temple and whales offshore in season." },
  { id: "nilaveli", name: "Nilaveli", region: "East", x: 265, y: 223, interests: ["beach"], blurb: "Wide pale sand and easy snorkelling out at Pigeon Island." },
  { id: "pasikuda", name: "Pasikuda", region: "East", x: 320, y: 347, interests: ["beach", "wellness"], blurb: "A shallow bay you can wade far out into — the calmest swimming water in the country." },
  { id: "arugam-bay", name: "Arugam Bay", region: "East", x: 356, y: 512, interests: ["beach", "wildlife"], blurb: "Sri Lanka's surf town, with lagoon safaris and elephants on the road home." },
  { id: "galle", name: "Galle", region: "South", x: 122, y: 645, interests: ["culture", "beach"], blurb: "A lived-in Dutch fort of ramparts, cafés and coral-stone houses above the sea." },
  { id: "unawatuna", name: "Unawatuna", region: "South", x: 130, y: 652, interests: ["beach", "wellness"], blurb: "A curved bay minutes from the fort — swimming, diving and long lazy evenings." },
  { id: "mirissa", name: "Mirissa", region: "South", x: 158, y: 660, interests: ["beach", "wildlife"], blurb: "The launching point for blue whale mornings, and a palm-covered headland to nap under after." },
  { id: "weligama", name: "Weligama", region: "South", x: 149, y: 657, interests: ["beach"], blurb: "A gentle beginner surf bay with stilt fishermen at the eastern end." },
  { id: "tangalle", name: "Tangalle", region: "South", x: 206, y: 648, interests: ["beach", "wildlife", "wellness"], blurb: "Quiet coves and boutique villas, an easy hour from the big southern safari parks." },
  { id: "bentota-area", name: "Bentota", region: "West", x: 96, y: 592, interests: ["beach", "wellness"], blurb: "River on one side, ocean on the other — watersports, Ayurveda and a lot of resort choice." },
  { id: "colombo", name: "Colombo", region: "West", x: 68, y: 504, interests: ["culture"], blurb: "The arrival city: markets, seafood, colonial arcades and a new skyline arguing with all of it." },
  { id: "negombo", name: "Negombo", region: "West", x: 66, y: 460, interests: ["beach", "wellness"], blurb: "Fifteen minutes from the airport, with fish markets, canals and a long open beach." },
  { id: "kalpitiya", name: "Kalpitiya", region: "West", x: 54, y: 298, interests: ["beach", "wildlife"], blurb: "Kitesurfing lagoons, dolphin pods and sandbar islands with nothing built on them." },
  { id: "kandy", name: "Kandy", region: "Hill Country", x: 182, y: 447, interests: ["culture", "spiritual", "mountains"], blurb: "The last royal capital, built around a lake and the temple that holds the Tooth Relic." },
  { id: "nuwara-eliya", name: "Nuwara Eliya", region: "Hill Country", x: 203, y: 498, interests: ["mountains", "wellness"], blurb: "Cool enough for a fire in the evening. Tea estates, a racecourse and hedged English gardens at 1,900m." },
  { id: "ella", name: "Ella", region: "Hill Country", x: 244, y: 514, interests: ["mountains"], blurb: "A gap in the mountains with a view all the way to the south coast on a clear day." },
  { id: "haputale", name: "Haputale", region: "Hill Country", x: 230, y: 530, interests: ["mountains", "wellness"], blurb: "A ridge village above the estates, where the cloud rolls up over the road every afternoon." },
  { id: "anuradhapura", name: "Anuradhapura", region: "Cultural Triangle", x: 148, y: 285, interests: ["spiritual", "culture"], blurb: "The first great capital: giant brick stupas, ancient reservoirs and the oldest recorded tree on earth." },
  { id: "polonnaruwa", name: "Polonnaruwa", region: "Cultural Triangle", x: 237, y: 343, interests: ["culture", "wildlife"], blurb: "A compact medieval capital best seen by bicycle, with carved Buddhas cut straight from the rock." },
  { id: "sigiriya", name: "Sigiriya", region: "Cultural Triangle", x: 201, y: 340, interests: ["culture", "mountains"], blurb: "A palace on top of a 200m rock, with frescoes and water gardens still working below it." },
  { id: "dambulla", name: "Dambulla", region: "Cultural Triangle", x: 185, y: 356, interests: ["spiritual", "culture"], blurb: "Five cave temples under one overhang, painted end to end and full of Buddha images." },
];
